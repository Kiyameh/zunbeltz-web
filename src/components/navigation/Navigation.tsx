              ...
              <li className={s.Span3}>
                <NavigationMenu.Link asChild>
                  <a href="/navarra" className={s.Navarra}>
                    <p>Navarra</p>
                    <img src={Navarra.src} alt="Escudo de Navarra" aria-hidden />
                  </a>
                </NavigationMenu.Link>
              </li>
              <li  >
                <NavigationMenu.Link asChild>
                  <a href="/navarra/cuevas" className={s.GridLink}>
                    ...
                    <p className={s.desc}>Zonas kársticas de Navarra y sus cavidades</p>
                  </a>
                </NavigationMenu.Link>
              </li>
              ...
              <li>
                <NavigationMenu.Link asChild>
                  <a href="/navarra/montañas" className={s.GridLink}>
                    ...
                    <p className={s.desc}>Las montañas y paisajes de la provincia</p>
                  </a>
                </NavigationMenu.Link>
              </li>
              <li >
                <NavigationMenu.Link asChild>
                  <a href="/navarra/rios" className={s.GridLink}>
                    ...
                    <p className={s.desc}>Ríos, foces y cauces del territorio</p>
                  </a>
                </NavigationMenu.Link>
              </li>
            </ul>
              ...
              <li >
                <NavigationMenu.Link asChild>
                  <a href="/exploracion/novedades" className={s.GridLink}>
                    ...
                    <p className={s.desc}>Novedades en la exploración espeleológica Navarra</p>
                  </a>
                </NavigationMenu.Link>
              </li>
              <li >
                <NavigationMenu.Link asChild>
                  <a href="https://subterra.app" target="_blank" className={s.GridLink}>
                    <p className={s.title}>Subterra.app</p>
                    <p className={s.desc}>Base de datos espeleológica para grupos de exploración</p>
                  </a>
                </NavigationMenu.Link>
              </li>
              <li >
                <NavigationMenu.Link asChild>
                  <a href="/exploracion/topografia" className={s.GridLink}>
                    ...
                    <p className={s.desc}>Método, herramientas y software de topografía de cavidades</p>
                  </a>
                </NavigationMenu.Link>
              </li>
              <li >
                <NavigationMenu.Link asChild>
                  <a href="/exploracion/fichas" className={s.GridLink}>
                    ...
                    <p className={s.desc}>Herramienta para generar fichas técnicas de instalación</p>
                  </a>
                </NavigationMenu.Link>
              </li>
            </ul>
              ...
              <li >
                <NavigationMenu.Link asChild>
                  <a href="/aprende/recorrido" className={s.GridLink}>
                    ...
                    <p className={s.desc}>El camino del buen amante de la aventura</p>
                  </a>
                </NavigationMenu.Link>
              </li>
              <li >
                <NavigationMenu.Link asChild>
                  <a href="/aprende/online" className={s.GridLink}>
                    ...
                    <p className={s.desc}>Mejora tu conocimiento con cursos online en todas las disciplinas</p>
                  </a>
                </NavigationMenu.Link>
              </li>
              <li >
                <NavigationMenu.Link asChild>
                  <a href="/aprende/cursos" className={s.GridLink}>
                    ...
                    <p className={s.desc}>Pon en práctica tus deportes favoritos en Navarra</p>
                  </a>
                </NavigationMenu.Link>
              </li>
              <li >
                <NavigationMenu.Link asChild>
                  <a href="/aprende/biblioteca" className={s.GridLink}>
                    ...
                    <p className={s.desc}>Libros, revistas y documentos técnicos</p>
                  </a>
                </NavigationMenu.Link>
              </li>
            </ul>
