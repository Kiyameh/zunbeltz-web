...
describe("Navigation", () => {
  ...
  describe("Functionality", () => {
    describe("Hovering", () => {
      ...
      it("should display caret icon on trigger items", () => {
        ...
        expect(
          screen.getByRole("button", { name: /Navarra/i }),
        ).toBeInTheDocument();
        expect(
          screen.getByRole("button", { name: /Exploración/i }),
        ).toBeInTheDocument();
        expect(
          screen.getByRole("button", { name: /Escuela/i }),
        ).toBeInTheDocument();
      });
    ...
    describe("Dropdown Content", () => {
      it("should display all Navarra dropdown items", async () => {
        ...
        expect(screen.getByText("Ríos")).toBeInTheDocument();
        expect(
          screen.getByText(/Zonas kársticas de Navarra/i),
        ).toBeInTheDocument();
      });
  ...
  describe("Accessibility", () => {
    ...
    it("should support Escape key to close dropdowns", async () => {
      ...
      // Al menos debe seguir siendo usable tras pulsar Escape
      expect(navarraTrigger).toBeInTheDocument();
    });
