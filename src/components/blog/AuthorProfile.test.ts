...
describe("AuthorProfile", () => {
  describe("Rendering", () => {
    test("Should render author name", async () => {
      const html = await renderAstroComponent(AuthorProfile, {
        props: { author },
      });
    ...
    test("Should not render social links when not available", async () => {
      const html = await renderAstroComponent(AuthorProfile, {
        props: { author: authorWithoutSocial },
      });
  ...
  describe("Functionality - Links", () => {
    ...
    test("Instagram link should have correct href and attributes", async () => {
      ...
      expect(html).toContain('href="https://www.instagram.com/andoniabarzuza"');
      expect(html).toMatch(
        /href="https:\/\/www\.instagram\.com\/andoniabarzuza"[^>]*target="_blank"/,
      );
      expect(html).toMatch(
        /href="https:\/\/www\.instagram\.com\/andoniabarzuza"[^>]*rel="noopener noreferrer"/,
      );
    });
    ...
    test("Facebook link should have correct href and attributes", async () => {
      ...
      expect(html).toContain('href="https://www.facebook.com/andoniabarzuza"');
      expect(html).toMatch(
        /href="https:\/\/www\.facebook\.com\/andoniabarzuza"[^>]*target="_blank"/,
      );
      expect(html).toMatch(
        /href="https:\/\/www\.facebook\.com\/andoniabarzuza"[^>]*rel="noopener noreferrer"/,
      );
    });
    ...
    test("Twitter link should have correct href and attributes", async () => {
      ...
      expect(html).toContain('href="https://twitter.com/andoniabarzuza"');
      expect(html).toMatch(
        /href="https:\/\/twitter\.com\/andoniabarzuza"[^>]*target="_blank"/,
      );
      expect(html).toMatch(
        /href="https:\/\/twitter\.com\/andoniabarzuza"[^>]*rel="noopener noreferrer"/,
      );
    });
    ...
    test("Website link should have correct href and attributes", async () => {
      ...
      expect(html).toContain('href="https://kiyameh.com/es/"');
      expect(html).toMatch(
        /href="https:\/\/kiyameh\.com\/es\/"[^>]*target="_blank"/,
      );
      expect(html).toMatch(
        /href="https:\/\/kiyameh\.com\/es\/"[^>]*rel="noopener noreferrer"/,
      );
    });
